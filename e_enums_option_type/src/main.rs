...
We can also use methods previously built with option type such as unwrap_or(0).
Above uses a value given in some or if the option type is None, it uses the default value given in the above parenthesis.
